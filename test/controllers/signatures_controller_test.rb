...
class SignaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post signatures_url, params: { signature: { dnanum_id: @signature.dnanum_id, uname: @signature.uname } }
    end
  ...
  test "should update signature" do
    patch signature_url(@signature), params: { signature: { dnanum_id: @signature.dnanum_id, uname: @signature.uname } }
